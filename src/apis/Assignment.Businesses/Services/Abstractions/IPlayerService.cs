...
public interface IPlayerService
{
    ...
    /// </summary>
    Task<Player?> UpdateAsync(Guid id, int totalPoint, int milestone, int totalChip,
        CancellationToken cancellationToken = default);

    Task<PlayerStateViewModel> GetStateAsync(Guid playerId, CancellationToken cancellation = default);
